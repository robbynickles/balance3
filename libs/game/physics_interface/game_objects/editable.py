...
class Editable( GameObject ):
    ...
    def __init__( self, physics_interface, start, end, thirdpt=None ):
        ...
        if thirdpt == None:
            # By default, the thirdpt starts as the line midpoint and isn't necessary for the segmentation.
            ...
            self.set_thirdpt( origin, dim, thirdpt ) 
            self.points = [ start, thirdpt, end ]
